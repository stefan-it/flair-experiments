...
tagger: SequenceTagger = SequenceTagger.load_from_file('resources/taggers/ud-dutch/best-model.pt')
...
for line in lines:
    if len(line) == 0:
      ...
      continue
        ...
        # 5       gemeenten       gemeente        NOUN    N|soort|mv|neut Number=Plur     11      nsubj   _       _
