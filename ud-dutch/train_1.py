...
sentences_train: List[Sentence] = NLPTaskDataFetcher.read_conll_ud("universal-dependencies-1.2/UD_Dutch/nl-ud-train.conllu")
sentences_dev: List[Sentence]   = NLPTaskDataFetcher.read_conll_ud("universal-dependencies-1.2/UD_Dutch/nl-ud-dev.conllu")
sentences_test: List[Sentence]  = NLPTaskDataFetcher.read_conll_ud("universal-dependencies-1.2/UD_Dutch/nl-ud-test.conllu")
...
trainer.train('resources/taggers/ud-dutch',
              learning_rate=0.1,
              mini_batch_size=8,
              max_epochs=500)
